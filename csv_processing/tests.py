...
class CSVProcessingAPITestCase(APITestCase):
    ...
    def test_upload_a_csv_file(self):
        ...
        response = self.client.get(
            reverse("api_csv_retrieve", kwargs={'processing_id': instance.processing_id}),
        )
    ...
    def test_retrieve_processes_with_real_data(self):
        ...
        self.assertEqual(response.data['processed_file'], 'http://testserver/media/processed/test_csv_output.csv')
